...
const AddCoffee = () => {
    const handleCoffeeSubmit = e => {
        ...
        fetch('https://coffee-store-server-five-mu.vercel.app/coffee', {
            method: 'POST',
            headers: {
        ...
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='bg-[#F4F3F0] p-6'>
                <div className='text-center pb-10 pt-10 '>
                    <h1 className='text-4xl font-bold pb-4 '>Add New Coffee</h1>
                ...
                <form onSubmit={handleCoffeeSubmit} >
                    ...
                    <div className='flex gap-16 space-y-3'>
                        <fieldset className='w-1/2 '>
                            ...
                            <input name='coffeeName' type="text" placeholder="coffee Name" className="input input-bordered w-full" />
                        </fieldset>
                        <fieldset className='w-1/2'>
                            <label className='inline-block pb-2 text-lg font-medium'>Available Quantity</label>
                            <input name='coffeeQuantity' type="text" placeholder="available quantity" className="input input-bordered w-full" />
                        </fieldset>
                    </div>
                    {/* supplier + taste  */}
                    ...
                    <div className='text-center pt-10 '>
                        <input type="submit" value="Add Coffee" className='btn w-full bg-[#D2B48C] text-[]' />
                    </div>
                </form>
            </div>
        </div>
